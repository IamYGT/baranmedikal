...
<head>
	...
	<title>Baran Medikal l 404 </title>
...
<?php include("ust.php")?>	
<!-- Full screen section -->
		<section class="full-screen fw-main-row">
			<div class="fw-container centered-container tac">
				<div class="container tac">
					<h1><span class="">Aradığınız sayfa bulunamadı.</span></h1>
 					<a href="index" class="button-style1"><span style="font-weight:700; color:#fff;">Anasayfa</span></a>
					<img src="images\404.jpg" alt="Baran Medikal" class="image-404">
				</div>
			</div>
		</section>
