...
class dbcon{
		...
		public $veritabani = "baranmedikal_site"; //veritabanı adı
		public $host="localhost";
		public $hesap="baran_site"; //kullanıcı adı
		public $sifre="Nrn1b373"; //sifre
		public $baglan;
...
function veriOku($tablo,$sartalan,$sartkarsilik)
		{
						$dondur =NULL;
						$yenisorgu = "SELECT * FROM $tablo WHERE $sartalan=?";
